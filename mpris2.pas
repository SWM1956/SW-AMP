...
// Lazarus' DBus unit may not provide dbus_connection_setup_with_g_main which
// integrates DBus with the GLib main loop.  Declare it here to avoid
// compilation errors when using older units.
